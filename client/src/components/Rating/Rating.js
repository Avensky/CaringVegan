...
const Rating = ({ rating }) => {
  ...
  switch (true) {
    case rating == 5:
      ratingArray = [star, star, star, star, star];
      break;
    case rating >= 4.5 && rating < 5:
      ratingArray = [star, star, star, star, star_half];
      break;
    case rating >= 4 && rating < 4.5:
      ratingArray = [star, star, star, star, star_border];
      break;
    case rating >= 3.5 && rating < 4:
      ratingArray = [star, star, star, star_half, star_border];
      break;
    case rating >= 3 && rating < 3.5:
      ratingArray = [star, star, star, star_border, star_border];
      break;
    case rating >= 2.5 && rating < 3:
      ratingArray = [star, star, star_half, star_border, star_border];
      break;
    case rating >= 2 && rating <= 2.5:
      ratingArray = [star, star, star_border, star_border, star_border];
      break;
    case rating >= 1.5 && rating < 2:
      ratingArray = [star, star_half, star_border, star_border, star_border];
      break;
    case rating >= 1 && rating < 1.5:
      ratingArray = [star, star_border, star_border, star_border, star_border];
      break;
