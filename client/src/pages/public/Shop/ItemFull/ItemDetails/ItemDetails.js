    ...
    ? (quantity = (
        <div className={classes.CardQuantityWrapper}>
          ...
          <div className={classes.CardQuantity}>
            <i
              className={["fa fa-minus", classes.MaterialIcons].join(" ")}
              onClick={props.subtractQuantity}
            />
            <p>{props.quantity}</p>
            <i
              className={["fa fa-plus", classes.MaterialIcons].join(" ")}
  ...
  return (
    <div className={[classes.Item, props.class].join(" ")} key={props.id}>
      ...
      <div className={props.myClass}>
        ...
        {/* Stock */}
        <div className={classes.CardStock}>{stock}</div>
        ...
        <div className={classes.CardPriceWrapper} onClick={props.addToCart}>
          <div className={["text-center noselect", classes.AddBtn].join(" ")}>
            <p>
              Add to Cart <b>${props.price.toFixed(2)}</b>
            </p>
          </div>
        </div>
      </div>
