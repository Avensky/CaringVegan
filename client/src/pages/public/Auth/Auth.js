    ...
    case "login":
      ...
      authSelector = (
        <div className={classes.AuthNav}>
          <button onClick={loginToggleHandler} className={selected}>
      ...
      !props.loading
        ? (socialAuth = (
            <Auxiliary>
              ...
              <button
                type="submit"
                className={[classes.Btn, "btn-primary"].join(" ")}
              >
                <a
                  href="/api/facebook"
        ...
        : (form = (
            <Auxiliary>
              ...
              <div className="flex">
                ...
                <span
                  className={
                    passwordComfirmShown ? "fa fa-eye-slash" : "fa fa-eye"
                  }
    ...
    case "reset-password":
      ...
      button = (
        <NavLink to="/resetPassword">
          <div className={classes.BtnDiv}>
            <span className={["fa fa-user"].join(" ")}></span>Reset Password
          </div>
        </NavLink>
      );
      break;
